...
#ifndef SAMPLE_APP_MCAL_TASK_2_H
#define SAMPLE_APP_MCAL_TASK_2_H
...
#include "sample_app_mcal_fr_task.h"
#endif
...
FUNC (Std_ReturnType, SAMPLE_APP_CODE) SampleAppTask2(P2VAR(SampleAppData_T, AUTOMATIC, SPI_VAR) pstSampleAppData);
...
#endif /* SAMPLE_APP_MCAL_TASK_2_H */
