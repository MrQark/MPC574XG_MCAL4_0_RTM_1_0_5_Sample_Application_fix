/**
    @file    sample_app_mcal_adc_task.h
    @version 1.0.5
...
#ifndef SAMPLE_APP_MCAL_ICU_TASK_H
#define SAMPLE_APP_MCAL_ICU_TASK_H
...
extern P2CONST(Icu_ConfigType, ICU_VAR, ICU_APPL_CONST) Icu_pCfgPtr;
...
#endif /* SAMPLE_APP_MCAL_ICU_TASK_H */
