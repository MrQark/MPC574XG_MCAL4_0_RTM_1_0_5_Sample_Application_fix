...
# Compilers' options
ccopt       = -cpu=$(proc) -c -vle -noSPE -G -dual_debug -O2 --diag_error 223 --no_exceptions \
              -Wimplicit-int -Wshadow -Wtrigraphs --prototype_errors --incorrect_pragma_warnings -Wundef \
              -preprocess_assembly_files -ansi --short_enum -noslashcomment -nostartfiles
