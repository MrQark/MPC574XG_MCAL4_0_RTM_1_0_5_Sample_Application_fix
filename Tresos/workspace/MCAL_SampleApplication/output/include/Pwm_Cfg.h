...
#define PWM_CFG_SW_PATCH_VERSION                  5
/**@}*/
...
*/
#define Pwm_Led1         ((Pwm_ChannelType)0U)

/** 
* @brief           Symbolic Names for configured channels - ecuc 2108 compliant.
*/
#define  PwmConf_PwmChannelConfigSet_Pwm_Led1         ((Pwm_ChannelType)0U)
...
extern FUNC(void, PWM_CODE)Pwm_Led1Notification(void);
