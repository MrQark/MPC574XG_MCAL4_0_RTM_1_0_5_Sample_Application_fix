...
#define ICU_SW_PATCH_VERSION_CFG                5
/*==================================================================================================
                                      FILE VERSION CHECKS
==================================================================================================*/
...
#define Pwm_measure                     (IcuConf_IcuChannel_Pwm_measure)
/* @violates @ref Icu_Cfg_h_REF_3 MISRA-C:2004 Rule 1.4: Identifier clash.*/
#define IcuConf_IcuChannel_Pwm_measure  ((Icu_ChannelType)0U) 
...
*   @{
*/
#define ICU_EMIOS_0_CH_1_ISR_USED 
