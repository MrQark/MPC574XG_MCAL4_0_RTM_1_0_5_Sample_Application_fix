...
#define WDG_SW_PATCH_VERSION_CFG             5
...
*/
#define WdgConf_WdgGeneral_WdgIndex2_U8 ((uint8)2)
...
#define WDG_CFG_EXTERN_DECLARATIONS \
    extern CONST(Wdg_ConfigType, WDG_CONST) Wdg_ConfigPB_0;    
