 ...
 * @violates @ref Wdg_43_Instance2_Lcfg_c_REF_1 MISRA 2004 Required Rule 19.15, precautions to prevent the contents
 *                of a header file being included twice
 * @violates @ref Wdg_43_Instance2_Lcfg_c_REF_4 MISRA 2004 Required Rule 19.1, only preprocessor statements
 ...
 * @violates @ref Wdg_43_Instance2_Lcfg_c_REF_5 MISRA 2004 Required Rule 8.8, An external object or function shall be declared in
 * one and only one file. This is an callback function from a macrofile
 */
...
/** @violates @ref Wdg_43_Instance2_Lcfg_c_REF_3  MISRA 2004 Required Rule 8.10, All declarations and definitions of objects or
 *   functions at file scope shall have internal linkage unless external linkage is required. 
 */
