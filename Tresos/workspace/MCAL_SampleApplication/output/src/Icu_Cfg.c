...
#define ICU_SW_PATCH_VERSION_PCCFG_C            5
...
/*
 *  @brief    PC Default EMIOS Configuration
 *  @violates @ref Icu_Cfg_c_3 violates Misra 8.10 external ... could be made static
 */
 CONST(Icu_eMios_ChannelConfigType, ICU_CONST) Icu_eMios_ChannelConfig_PC0[1] =
 {
 ...
 *  @violates @ref Icu_Cfg_c_3 violates Misra 8.10 external ... could be made static
 */
 CONST(Icu_eMios_IpConfigType, ICU_CONST) Icu_eMiosIcu_IpConfig_PC0 =
 {
