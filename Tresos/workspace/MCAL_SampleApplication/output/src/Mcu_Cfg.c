...
/**
    ...
    ARConfVariant
    SWVersion 1.0.5
    BuildVersion MPC574XG_MCAL_1_0_5_RTM_ASR_REL_4_0_REV_0003_20171215
...
static CONST( Mcu_DemConfigType, MCU_CONST) Mcu_Dem_ConfigPC0 = 
{
    ...
    {(uint32)STD_ON, DemConf_DemEventParameter_DEM_E_GENERAL_FAILURE},
...
static CONST(Mcu_RamConfigType, MCU_CONST) Mcu_aRamConfigPC0[1] = 
{

    {
         ...
         *  @violates @ref Mcu_Cfg_c_REF_9 MISRA 2004 Advisory Rule 11.3 The cast is used to access memory mapped registers.
         */
...
static CONST( Mcu_MC_ME_CoreAddressConfigType, MCU_CONST) Mcu_aModeCoreAdressConfigPC0_0[MCU_MC_ME_NUMBER_OF_CORES] = 
{
...
{    
    ...
    /* Start of Mcu_ModeConfig[0] - DRUN */
    {
        ...
        ,&Mcu_aModeCoreAdressConfigPC0_0
#endif /* MCU_CONFIGURE_CADDRN == STD_ON */
...
static CONST( Mcu_FLASH_ClockConfigType, MCU_CONST) FLASH_ClockConfigPC0_0 = 
{
...
#if (MCU_INIT_CLOCK == STD_ON)
static CONST( Mcu_MC_CGM_RegisterConfigType, MCU_CONST) MC_CGM_aAuxClockConfigPC0_0[12] = 
{
...
*
*/
static CONST( Mcu_MC_CGM_ClockConfigType, MCU_CONST) MC_CGM_ClockConfigPC0_0 = 
{
...
*
*/
static CONST( Mcu_SIRC_ConfigType, MCU_CONST) Mcu_SIRC_ClockConfigPC0_0 =
{
    /* Control register */
...
*
*/
static CONST( Mcu_FIRC_ConfigType, MCU_CONST) Mcu_FIRC_ClockConfigPC0_0 =
{
    /* Control register */
...
*
*/
static CONST( Mcu_SXOSC_ConfigType, MCU_CONST) Mcu_SXOSC_ClockConfigPC0_0 =
{
    /* Control register */
    SXOSC_CTL_VALUE_U32(
...
*
*/
static CONST( Mcu_FXOSC_ConfigType, MCU_CONST) Mcu_FXOSC_ClockConfigPC0_0 =
{
    /* Control register */
    FXOSC_CTL_VALUE_U32(
...
#if (MCU_INIT_CLOCK == STD_ON)
/** @violates @ref Mcu_Cfg_c_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
static CONST( Mcu_PLLDIG_RegisterConfigType, MCU_CONST) Mcu_PLLDIG_aRegistersConfigPC0_0[5U] = 
{
...
static CONST(Mcu_eMios_ConfigType, MCU_CONST) EMIOS_ModuleConfigPC0_0 = 
{
    {
...
*
*/
static CONST( Mcu_CMU_ConfigType, MCU_CONST) Mcu_CMU_ConfigPC0_0 =
{
    {
...
MC_ME_SYSCLK_PLL0_U32 | MC_ME_PLL0_EN_U32 
        ...
        &Mcu_FIRC_ClockConfigPC0_0,
        
        
        /* SIRC IP Clock settings. */
        
        &Mcu_SIRC_ClockConfigPC0_0,
        
        
        /* FXOSC IP Clock settings. */
        
        &Mcu_FXOSC_ClockConfigPC0_0,
        
        
        /* SXOSC IP Clock settings. */
        
        &Mcu_SXOSC_ClockConfigPC0_0,
...
static CONST( Mcu_MC_RGM_ConfigType, MCU_CONST) MC_RGM_ConfigPC0 =
{
    ...
    (
        ...
        (MC_RGM_Z4A_DBG_EVENT_RESET_U32) |
        (MC_RGM_CMU_OLR_EVENT_RESET_U32) |
        (MC_RGM_JTAG_FUNC_EVENT_RESET_U32) |
        (MC_RGM_NMI_WKPU_EVENT_RESET_U32)
...
static CONST( Mcu_MC_ME_CoreAddressConfigType, MCU_CONST) MC_ME_aCaddrConfigPC0[MCU_MC_ME_NUMBER_OF_CORES] = 
{
    /* Core Control Register (ME_CADDR1) */
    {
        MC_ME_CADDR1_ADDR32,
        MC_ME_CADDR_ADDR_MASK32 | MC_ME_CADDR_RMC_MASK32,
        MC_ME_CADDR_ENABLE_U32
        (
             MC_ME_CADDR_ADDR_U32(0x00000000U) |
...
static CONST( Mcu_MC_ME_CoreConfigType, MCU_CONST) MC_ME_aCctlConfigPC0[MCU_MC_ME_NUMBER_OF_CORES] = 
{
...
static CONST( Mcu_MC_ME_RegisterConfigType, MCU_CONST) MC_ME_aPCTLConfigPC0_0[MCU_MC_ME_NUMBER_OF_PCTL_REGS] = 
{
    ...
    {
        MC_ME_PCTL72_ADDR32,
        MC_ME_PCTLn_U8(MC_ME_PCTL_DBG_FRZ_DIS_U8, MC_ME_CFG_RUN_PC1_U8, MC_ME_CFG_LP_PC0_U8)
    },
...
static CONST( Mcu_MC_ME_ConfigType, MCU_CONST) MC_ME_ConfigPC0 =
{
    ...
    /* configuration of CADDRs */
    MCU_MC_ME_NUMBER_OF_CORES,
    &MC_ME_aCaddrConfigPC0,
    
    /* configuration of CCTLs */
    MCU_MC_ME_NUMBER_OF_CORES,
    &MC_ME_aCctlConfigPC0
};
...
static CONST( Mcu_PMCDIG_ConfigType, MCU_CONST) PMCDIG_ConfigPC0 =
{
...
*
*/
static CONST( Mcu_HwIPsConfigType, MCU_CONST) Mcu_HwIPsConfigPC0 =
{
