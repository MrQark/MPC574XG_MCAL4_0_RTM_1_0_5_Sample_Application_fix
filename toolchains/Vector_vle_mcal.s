...
#=================================================
    ...
    .globl LINFLEX_SCI_Isr_UART_TX
# Lin related
    .globl Lin_Linflex_IsrRx_LINFlex_1
    .globl Lin_Linflex_IsrTx_LINFlex_1
    .globl Lin_Linflex_IsrError_LINFlex_1
...
# Spi related
    .globl Spi_Dspi_IsrTCF_DSPI_0
    #.globl Spi_Dspi_IsrEOQ_DSPI_1

# Wdg related
    .globl Wdg_Swt0_Isr

# ADC related
    #.globl Adc_EndGroupConvUnit0
    .globl Adc_Adcdig_EndGroupConvUnit1

#PWM/ICU related
    .globl EMIOS_0_CH_0_CH_1_ISR
    #.globl 
...
IRQ226:
    ...
    .align ALIGN_SIZE
IRQ227:
    e_b Gpt_PIT_0_TIMER_1_ISR         #interrupt 227
    .align ALIGN_SIZE
IRQ228:
    e_b .         #interrupt 228
    .align ALIGN_SIZE
...
IRQ261:
    ...
    .align ALIGN_SIZE
IRQ262:
    e_b Spi_Dspi_IsrTCF_DSPI_0         #interrupt 262
    .align ALIGN_SIZE
IRQ263:
    e_b .         #interrupt 263
    .align ALIGN_SIZE
...
IRQ378:
    ...
    .align ALIGN_SIZE
IRQ379:
	e_b Lin_Linflex_IsrRx_LINFlex_1           #interrupt 379
    .align ALIGN_SIZE
IRQ380:
	e_b Lin_Linflex_IsrTx_LINFlex_1           #interrupt 380
    .align ALIGN_SIZE
IRQ381:
	e_b Lin_Linflex_IsrError_LINFlex_1           #interrupt 381
    .align ALIGN_SIZE
IRQ382:
	e_b .            #interrupt 382
    .align ALIGN_SIZE
IRQ383:
	e_b LINFLEX_SCI_Isr_UART_TX           #interrupt 383
    .align ALIGN_SIZE
IRQ384:
	e_b .           #interrupt 384
    .align ALIGN_SIZE
...
IRQ553:
    ...
    .align ALIGN_SIZE
IRQ554:
	e_b Adc_Adcdig_EndGroupConvUnit1           #interrupt 554
    .align ALIGN_SIZE
IRQ555:
	e_b .           #interrupt 555
    .align ALIGN_SIZE
...
IRQ705:
    ...
    .align ALIGN_SIZE
IRQ706:
	e_b EMIOS_0_CH_0_CH_1_ISR           #interrupt 706
    .align ALIGN_SIZE
IRQ707:
	e_b .           #interrupt 707
    .align ALIGN_SIZE
