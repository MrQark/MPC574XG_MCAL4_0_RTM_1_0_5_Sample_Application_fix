...
/* global variables for CER module */
uint16_t Cer_ModuleId;       /**< @brief CER module ID*/
uint8_t Cer_InstanceId;     /**< @brief CER instance ID*/
uint8_t Cer_ApiId;          /**< @brief CER API ID*/
uint8_t Cer_ErrorId;        /**< @brief CER Error ID*/
extern void _start_OS(void);
...
/******************************************************************/
/* The interrupt controller is set up by Autosar OS */
