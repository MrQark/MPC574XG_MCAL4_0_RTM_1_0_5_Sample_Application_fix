...
#define ADC_SW_PATCH_VERSION_CFG                5
...
==================================================================================================*/
/**
* @brief Returns the cut version of the chip cut 1.1 is TRUE and cut 1.2 is FAILSE
* @details Global define to detect the chip version
*/
#define ADC_DMA_NOT_SUPPORT_CLEAR_SEQUENCE        ((RUNS_ON_CHIP() == 0x64D) && (RUNS_ON_CUT() == 20))
