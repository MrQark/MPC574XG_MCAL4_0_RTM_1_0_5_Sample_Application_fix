...
#define ADC_SW_PATCH_VERSION_CFG_DEFINES                5
...
#define ADC_ICNCMR1_AVAILABLE    (STD_OFF)
#define ADC_ICNCMR2_AVAILABLE    (STD_OFF)
#define ADC_TCNCMR_AVAILABLE     (STD_OFF)
#define ADC_ECNCMR0_AVAILABLE    (STD_OFF)
#define ADC_ECNCMR1_AVAILABLE    (STD_OFF)
#define ADC_ECNCMR2_AVAILABLE    (STD_OFF)
#define ADC_ECNCMR3_AVAILABLE    (STD_OFF)
/**
