...
#define LIN_SW_PATCH_VERSION_CFG             5
/*==================================================================================================
                                      FILE VERSION CHECKS
==================================================================================================*/
...
* @api
*/
#define LIN_HW_MAX_AVAILABLE_MODULES 16U
...
* @api
*/
#define  LIN_TIMEOUT_LOOPS 65535U
...
#define LIN_DUAL_CLOCK_MODE  (STD_ON) /* Enable API Lin_SetClockMode */
/**
...
* external identifiers.
*/
#define LinConf_LinChannelConfiguration_LinChannel_0         0
...
#define LIN_DISABLE_DEM_REPORT_ERROR_STATUS   (STD_OFF)  /* Enable Production Error Detection */
...
typedef struct
{
    ...
    VAR(uint8, LIN_VAR) u8DualClock;                /*!< Dual Clock Mode is en/dis */
...
*/
extern CONST(Lin_ConfigType,LIN_CONST)LinGlobalConfig_0;
