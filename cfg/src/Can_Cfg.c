...
#define CAN_SW_PATCH_VERSION_PCCFG_C             5
...
static CONST(Can_ControllerBaudrateConfigType, CAN_CONST) ControllerBaudrateConfigs_PC_0[CAN_CFGSET0_MAX_BAUDRATE_FC_A_0] = 
{
    ...
    */
    /* Configuration for CanController ID0 == FlexCAN_A */
    {
        ...
        /* @violates @ref Can_Cfg_c_REF_6 Violates MISRA 2004 Required Rule 10.1*/
        /* @violates @ref Can_Cfg_c_REF_7 Violates MISRA 2004 Required Rule 9.2*/
        },
        #endif 
