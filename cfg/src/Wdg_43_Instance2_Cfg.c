...
#define WDG_SW_PATCH_VERSION_CFG_C             5
...
* @violates @ref Wdg_43_Instance2_Cfg_c_REF_1 MISRA 2004 Required Rule 19.1, only preprocessor statements
*                and comments before '#include'
* @violates @ref Wdg_43_Instance2_Cfg_c_REF_2 MISRA 2004 Required Rule 19.15, precautions to prevent the contents
 ...
 * @violates @ref Wdg_43_Instance2_Cfg_c_REF_5 MISRA 2004 Required Rule 8.8, An external object or function shall be declared in
 * one and only one file. This is an callback function from a macrofile
 */
...
/** @violates @ref Wdg_43_Instance2_Cfg_c_REF_4 MISRA 2004 Required Rule 8.10, All declarations and definitions of objects or
 *   functions at file scope shall have internal linkage unless external linkage is required. 
 */
CONST(Wdg_Swt_ConfigType, WDG_CONST) Wdg_Swt_OffModeSettings_Instance2=
{
