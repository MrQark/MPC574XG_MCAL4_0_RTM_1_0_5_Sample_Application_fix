...
#define ADC_SW_PATCH_VERSION_CFG_C             5
...
*
*/
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group0_AssignmentPC_1[ADC_CFGSET1_GROUP_0_CHANNELS] =
{
    0U
};
...
*/
static CONST(Adc_Adcdig_ChannelConfigurationType, ADC_CONST) Adc_ChannelsCfgPC_1[] =
{
