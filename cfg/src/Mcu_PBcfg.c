...
static CONST(Mcu_RamConfigType, MCU_CONST) Mcu_aRamConfigPB0[1] = 
{

    {
         ...
         *  @violates @ref Mcu_PBcfg_c_REF_9 MISRA 2004 Advisory Rule 11.3 The cast is used to access memory mapped registers.
         */
...
static CONST( Mcu_MC_ME_RegisterConfigType, MCU_CONST) MC_ME_aPCTLConfigPB0_0[MCU_MC_ME_NUMBER_OF_PCTL_REGS] = 
{
...
CONST(Mcu_ConfigType, MCU_CONST)McuConfigPB_0 = 
{
#if (MCU_DISABLE_DEM_REPORT_ERROR_STATUS == STD_OFF)
