...
#define ADC_SW_PATCH_VERSION_PBCFG_C             5
...
*
*/
static CONST(Adc_ChannelType, ADC_CONST) Adc_Group0_AssignmentPB_1_1[ADC_CFGSET1_GROUP_0_CHANNELS] =
{
    0U
};
...
/**
* @brief          Definition of channels on ADC Hardware unit 1 - Configuration 1.
* @details        Array of conversion command messages
*/
static CONST(Adc_Adcdig_ChannelConfigurationType, ADC_CONST) Adc_ChannelsCfgPB_1_1[] =
{
...
{
    /**< @brief Group0 -- Hardware Unit ADC1 */
    {
...
/**
* @brief          Definition of channels limit checking on ADC Hardware unit 1.
*/
...
{
    (uint32)STD_ON,
    (uint16)DemConf_DemEventParameter_ADC_E_TIMEOUT
};
