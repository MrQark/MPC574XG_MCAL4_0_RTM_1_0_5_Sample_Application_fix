...
#define SPI_SW_PATCH_VERSION_LTCFG_C                     5
...
/* DspiChannelAttributesConfig_LT Channel Attribute Configuration of SpiDriver_0*/
static CONST(Spi_Ipw_ChannelAttributesConfigType, SPI_CONST) DspiChannelAttributesConfig_LT[1] =
{
...
/* DspiDeviceAttributesConfig_LT Device Attribute Configuration of SpiDriver_0*/
static CONST(Spi_Ipw_DeviceAttributesConfigType, SPI_CONST) DspiDeviceAttributesConfig_LT[1] =
{
    {  /* SpiExternalDevice_0 */
